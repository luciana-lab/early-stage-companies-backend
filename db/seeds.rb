...
copenotes = Company.create(
    ...
    video: "https://www.youtube.com/watch?v=zKEUnCnuSK4",
...
funkybunchpetcare = Company.create(
    ...
    video: "https://www.youtube.com/watch?v=Yan9ccNmym4&t=5s",
    location: "Sedalia, MO",
...
restore = Company.create(
    ...
    video: "https://www.youtube.com/watch?v=H80AmN7Whpg&t=249s",
...
purebarre = Company.create(
    ...
    video: "https://www.youtube.com/watch?v=fq0Ko4pt4LA&t=945s",
...
startupsuccessplatform = Company.create(
    ...
    video: "https://www.facebook.com/watch/?v=649580349389472&t=287",
    location: "Tampa, FL",
    need_category: "Networking",
...
chaosbrewco = Company.create(
    ...
    video: "https://www.youtube.com/watch?v=8VgXDo4Q4uI&t=39s",
    location: "Joplin, MO",
    need_category: "Sales",
